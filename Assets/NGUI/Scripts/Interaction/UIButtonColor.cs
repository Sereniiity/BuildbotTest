...
public class UIButtonColor : UIWidgetContainer
{
	...
	/// <summary>
	/// Occurs when state change to Pressed.
	/// </summary>
	public event myAction OnSetStatePressed;
	
	
	/// <summary>
	/// Occurs when state change from Pressed to another.
	/// </summary>
	public event myAction OnUnsetStatePressed;
	...
	public virtual void SetState (State state, bool instant)
	{
		...
		if (!wasPressed && state == State.Pressed) 
		{
			wasPressed = true;
			if (OnSetStatePressed != null)
				OnSetStatePressed ();
		} 
		else if (wasPressed && state != State.Pressed)
		{
			wasPressed = false;
			if (OnUnsetStatePressed != null)
				OnUnsetStatePressed ();
		}
